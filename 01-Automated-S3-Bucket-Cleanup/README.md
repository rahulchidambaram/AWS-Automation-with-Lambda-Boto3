...
![S3 bucket with test files uploaded](images/02-s3-bucket-test-files.png)
...
![IAM inline policy JSON step 1](images/03-iam-role-inline-policy-json-1.png)
![IAM inline policy JSON step 2](images/04-iam-role-inline-policy-json-2.png)
![IAM inline policy JSON step 3](images/05-iam-role-inline-policy-json-3.png)
...
![Lambda function code pasted, step 1](images/06-lambda-function-code-1.png)
![Lambda function code pasted, step 2](images/07-lambda-function-code-2.png)
![Lambda function code pasted, step 3](images/08-lambda-function-code-3.png)
...
![Test event setup](images/09-test-event-setup.png)

**Before Deletion**

![CloudWatch logs before deletion](images/10-before-deletion-cloudwatch-logs.png)
![S3 bucket before deletion](images/11-before-deletion-s3-bucket.png)

**After Clean-up**

![CloudWatch logs after cleanup](images/12-after-cleanup-cloudwatch-logs.png)
![S3 bucket after cleanup](images/13-after-cleanup-s3-bucket.png)
